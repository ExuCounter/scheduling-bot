...
var Schedular = /** @class */ (function () {
            ...
            setInterval(function () {
                ...
                todayLessons.map(function (lesson) {
                    ...
                    if (currentTime === notificationTime) {
                        if (lesson.subgroup === 1 && _this.currentGroupsLessons.firstGroup.time !== lessonTime) {
                            ...
                            _this.currentGroupsLessons.firstGroup = __assign({}, lesson);
                        }
                        else if (lesson.subgroup === 2 && _this.currentGroupsLessons.secondGroup.time !== lessonTime) {
                            helpers_1.sendMessage("\u0427\u0435\u0440\u0435\u0437 5 \u043C\u0438\u043D\u0443\u0442 \u043F\u0430\u0440\u0430 \u0443 \u0432\u0442\u043E\u0440\u043E\u0439 \u043F\u043E\u0434\u0433\u0440\u0443\u043F\u043F\u044B \n" + helpers_1.formatLesson(lesson));
                            helpers_1.sendUsersNotification(users_1.secondGroupNicknames);
                            _this.currentGroupsLessons.secondGroup = __assign({}, lesson);
                        }
                        else if (lesson.subgroup === 'both' &&
                            _this.currentGroupsLessons.firstGroup.time !== lessonTime &&
                            _this.currentGroupsLessons.secondGroup.time !== lessonTime) {
                    ...
                    if (currentTime === _this.MORNING_NOTIFICATION_TIME && !_this.doesMorningNotificated) {
                        _this.showTodaySchedular();
                        _this.doesMorningNotificated = true;
                    }
                });
    ...
    Schedular.prototype.showNextLesson = function (subgroup) {
        ...
        if (data.currentLesson) {
            helpers_1.sendMessage("\u0421\u043B\u0435\u0434\u0443\u044E\u0449\u0430\u044F \u043F\u0430\u0440\u0430 \u0443 " + groupName + " \u043F\u043E\u0434\u0433\u0440\u0443\u043F\u043F\u044B:\n" + helpers_1.formatLesson(data.currentLesson));
        }
        else {
            helpers_1.sendMessage("\u041D\u0430 \u0441\u0435\u0433\u043E\u0434\u043D\u044F \u043F\u0430\u0440\u044B \u0443 " + groupName + " \u043F\u043E\u0434\u0433\u0440\u0443\u043F\u043F\u044B \u0437\u0430\u043A\u043E\u043D\u0447\u0438\u043B\u0438\u0441\u044C.");
        }
    };
    Schedular.prototype.handleActions = function () {
        ...
        bot_1.bot.on('message', function (message) {
            ...
            if (messageText.startsWith(types_1.Actions.currentWeekNumber)) {
                _this.showCurrentWeek();
            }
            else if (messageText.startsWith(types_1.Actions.todaySchedular)) {
                _this.showTodaySchedular();
            }
            else if (messageText.startsWith(types_1.Actions.nextLessonFirstGroup)) {
                _this.showNextLesson(1);
            }
            else if (messageText.startsWith(types_1.Actions.nextLessonSecondGroup)) {
